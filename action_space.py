...
class Space:
    ...
    def rebuild_flann(self):
        self._index = self._flann.build_index(self.__space, algorithm='kdtree', target_precision=0.98)
...
class Discrete_space(Space):
    """
        Discrete action space with n dicrete actions (the integers in the range [0, n))
        0, 1, 2, ..., n-2, n-1
